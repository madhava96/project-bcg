...
urlpatterns = [
    ...
    path('adminemployeeform',views.adminemployeeform,name='adminemployeeform'),
    path('empdetails',views.empdetails,name='details'),
    path('adminempdetails',views.adminempdetails,name='adminempdetails'),
    path('book',views.book, name='book'),
    path('check',views.check, name='check'),
    path('show',views.show,name='show'),
    path('hotelabout',views.hotelabout,name="hotelabout"),
    path('hotelrooms',views.hotelrooms,name="hotelrooms"),
